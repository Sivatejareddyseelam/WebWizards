...
def login():
    ...
    if form.validate_on_submit():
        ...
        if not next_page or urlsplit(next_page).netloc != '':
            ...
            next_page = url_for('main.user', username=customer.username)
...
def register():
    ...
    if form.validate_on_submit() and form.agree_terms.data:
        customer = Customer(username=form.username.data, customer_full_name = form.fullname.data, 
                            customer_company_name = form.companyname.data, customer_email=form.email.data,
